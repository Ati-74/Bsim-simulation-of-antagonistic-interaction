...
public class AtiDiffusibleToxinBacterium extends Bacterium {
    ...
    public AtiDiffusibleToxinBacterium(BSim sim, BSimChemicalField toxin, BSimChemicalField resistant, Vector3d px1, Vector3d px2){
    ...
    public AtiDiffusibleToxinBacterium(BSim sim, BSimChemicalField toxin, BSimChemicalField resistant, Vector3d px1, Vector3d px2, long origin_id, long parent_id){
    ...
    public void set_elMean(double el_mean) { AtiDiffusibleToxinBacterium.initial_el_mean = el_mean; }
    /** Sets the elongation stdv. **/
    public void set_elStdv(double el_stdv) { AtiDiffusibleToxinBacterium.initial_el_stdv = el_stdv; }

    /** Sets the elongation stdv. **/
    public void set_enzymNUM(double enzymeNum) { AtiDiffusibleToxinBacterium.enzymeNum = enzymeNum; }



    // This function is called when the bacterium has passed its' division threshold and is ready to divide.
    @Override
	public AtiDiffusibleToxinBacterium divide() {
        ...
        AtiDiffusibleToxinBacterium child = new AtiDiffusibleToxinBacterium(sim, toxin_field, resistant_field, x1_child, new Vector3d(this.x2), this.origin_id, this.id);
