...
public class BSimAtiMonoCulture {
    ...
    private static String pathToSimulation = projectPath+"/run/"+"BsimAtiMonoCulture/";

    @Parameter(names = "-export_path", description = "export location")
    private String export_path = pathToSimulation+"/MonoCultureResults";
    ...
    final ArrayList<AtiMonoCultureBacterium> suscp_bac = new ArrayList();
    ...
    final ArrayList<AtiMonoCultureBacterium> bac_bornbacSuscp = new ArrayList();

    final ArrayList<AtiMonoCultureBacterium> bac_deadbacSuscp = new ArrayList();
    ...
    public static void main(String[] args) {
    	...
    	BSimAtiMonoCulture bsim_ex = new BSimAtiMonoCulture();
    ...
    public static AtiMonoCultureBacterium createBacterium(BSim sim) {
        ...
        AtiMonoCultureBacterium bacterium = new AtiMonoCultureBacterium(sim,pos1, pos2);
    ...
    public void run() {
        ...
        while ( bacteriaAll.size() < initialPopulation ) {
            ...
            // Creates a new bacterium object whose endpoints correspond to the above data
            AtiMonoCultureBacterium suscp_bacterium = createBacterium( sim);
        ...
        AtiMonoCultureTicker ticker = new AtiMonoCultureTicker(sim, suscp_bac, bacteriaAll, LOG_INTERVAL, bacRng,
         ...
         * Set up the drawer
         */
        AtiMonoCultureDrawer drawer = new AtiMonoCultureDrawer(sim, width_um, height_um, window_width, window_height,
        		 suscp_bac,SINGLE_SCREEN);
