...
/**
 * This class represents a Mono Culture of susceptible bacteria.
 */
public class AtiMonoCultureBacterium extends PhysicalContactBacterium {
    ...
    public AtiMonoCultureBacterium(BSim sim,Vector3d px1, Vector3d px2){
    ...
    public AtiMonoCultureBacterium(BSim sim,Vector3d px1, Vector3d px2, long origin_id, long parent_id){
    ...
    public void set_elMean(double el_mean) { AtiMonoCultureBacterium.initial_el_mean = el_mean; }
    /** Sets the elongation stdv. **/
    public void set_elStdv(double el_stdv) { AtiMonoCultureBacterium.initial_el_stdv = el_stdv; }



    // This function is called when the bacterium has passed its' division threshold and is ready to divide.
    @Override
	public AtiMonoCultureBacterium divide() {
        ...
        AtiMonoCultureBacterium child = new AtiMonoCultureBacterium(sim,x1_child, new Vector3d(this.x2), this.origin_id, this.id);
