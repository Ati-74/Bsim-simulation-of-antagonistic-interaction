...
public class AtiT6SSDrawer extends BSimP3DDrawer{
	...
	public void scene(PGraphics3D p3d) {
        ...
        for (AtiT6SSBacterium element : attacker_bac) {
        	draw(element, Color.RED);
        }

        // Draw sub-population B
        for (AtiT6SSBacterium element : suscp_bac) {
        	draw(element,element.contacttime>20? Color.BLACK : Color.YELLOW);
        }
    }
}
