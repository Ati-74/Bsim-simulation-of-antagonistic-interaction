...
public class AtiT6SSBacterium extends PhysicalContactBacterium {
    ...
    public void set_elMean(double el_mean) { AtiT6SSBacterium.initial_el_mean = el_mean; }
    /** Sets the elongation stdv. **/
    public void set_elStdv(double el_stdv) { AtiT6SSBacterium.initial_el_stdv = el_stdv; }
