...
public class TestPhysicalContactBacterium extends PhysicalContactBacterium {
    ...
    public void set_elMean(double el_mean) { TestPhysicalContactBacterium.initial_el_mean = el_mean; }
    /** Sets the elongation stdv. **/
    public void set_elStdv(double el_stdv) { TestPhysicalContactBacterium.initial_el_stdv = el_stdv; }
